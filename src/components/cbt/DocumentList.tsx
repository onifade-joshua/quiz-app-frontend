    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 sm:mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          ...
          >
            ...
            <span className="hidden sm:inline">Start CBT Practice ({selectedDocuments.length})</span>
      ...
      {documents.length === 0 ? (
        <div className="text-center py-8 sm:py-12">
          ...
          <p className="text-slate-500 mb-4 text-sm sm:text-base">No documents uploaded yet</p>
          <button
            onClick={onImportMore}
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center mb-2">
                    ...
                    />
                    <h3 className="font-semibold text-slate-900 text-sm sm:text-base truncate">{doc.title}</h3>
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 ml-6 sm:ml-7">
                    {doc.audioExplanation && (
                      ...
                      >
                        {isPlaying[doc.id] ? <Pause className="w-3 h-3 sm:w-4 sm:h-4 mr-1" /> : <Play className="w-3 h-3 sm:w-4 sm:h-4 mr-1" />}
                ...
                <div className="text-right sm:ml-4 flex-shrink-0">
                  <span className="text-xs sm:text-sm font-medium text-slate-700">{doc.subject}</span>
