...
export default function ReviewView({ results, isPlaying, onPlayAudio, onRetake, onBack }: ReviewViewProps) {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex space-x-2">
              <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm flex items-center font-medium">
                <CheckCircle className="w-4 h-4 mr-1" />
                {results.correctAnswers} Correct
              </span>
              <span className="bg-red-100 text-red-800 px-3 py-1 rounded-full text-sm flex items-center font-medium">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={onBack}
              className="flex items-center px-4 py-2 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors font-medium"
            >
      ...
      <div className="space-y-6">
        {results.answers.map((answer, index) => (
          ...
          >
            ...
            {/* Answer Summary */}
            <div className="flex flex-wrap items-center gap-4 mb-4 p-3 bg-slate-50 rounded-lg text-sm">
              <div>
            ...
            <AnimatePresence>
              {showExplanations && (
                ...
                >
                  ...
                  <p className="text-slate-700 mb-4 leading-relaxed">{answer.explanation}</p>
      ...
      {/* Review Summary */}
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 sticky bottom-4">
        <div className="flex items-center justify-between">
