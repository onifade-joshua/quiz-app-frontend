          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-slate-900">StudyMaster Pro</h1>
                  <p className="text-sm text-slate-500">Enterprise Learning Platform</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-80"
                />
              </div>
              ...
              <div className="flex items-center space-x-3">
                <div className="text-right">
                  ...
                  <p className="text-xs text-slate-500">{user.level} • {user.university}</p>
                </div>
