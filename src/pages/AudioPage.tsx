      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center justify-between">
            <div className="flex flex-col sm:flex-row gap-3 flex-1">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center border border-slate-200 rounded-xl">
                  <button
                    ...
                    className={`p-2 ${viewMode === "grid" ? "bg-purple-100 text-purple-600" : "text-slate-600 hover:bg-slate-50"} transition-colors`}
                  >
                    <Grid3X3 className="w-4 h-4" />
                  </button>
                  <button
                    onClick={() => setViewMode("list")}
                    className={`p-2 ${viewMode === "list" ? "bg-purple-100 text-purple-600" : "text-slate-600 hover:bg-slate-50"} transition-colors`}
                  >
            ...
            <div className="flex items-center gap-2">
              <select className="px-3 py-2 border border-slate-200 rounded-xl bg-white text-sm focus:outline-none focus:ring-2 focus:ring-purple-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100">
              <div className="p-6 border-b border-slate-100">
                <h2 className="text-lg font-semibold text-slate-900">Audio Library</h2>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <h3 className="font-medium text-slate-900 truncate">{audio.title}</h3>
                            {audio.isNew && (
                          ...
                          <p className="text-slate-600 text-sm">{audio.instructor}</p>
                          <p className="text-slate-500 text-xs mt-1 line-clamp-1">{audio.description}</p>
                        </div>
          ...
          >
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-slate-600 text-sm">Hours Listened</span>
                  <span className="font-semibold text-slate-900">47.2h</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-600 text-sm">Explanations Completed</span>
                  <span className="font-semibold text-slate-900">89</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-600 text-sm">Favorite Subject</span>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="flex items-center justify-between">
                    ...
                    <span className={`text-sm font-medium ${item.color}`}>{item.plays}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
              ...
              <div className="space-y-3">
                {audioExplanations.slice(0, 4).map((audio, index) => (
                  <div
                    key={audio.id}
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="flex items-center gap-3 p-2 bg-purple-50 rounded-lg">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-slate-900">{achievement.title}</h4>
